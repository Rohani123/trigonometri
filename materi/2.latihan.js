...
function mencobakuadran2() {
    var x = document.getElementById("cobakuadran2").value;
    var y = document.getElementById("cobakuadran22").value;


    
   
    if (x == "60") {
        document.getElementById('cobakuadran2').style="border: 3px solid green; font-size:15px; text-align:center;"
        
    } else {
        document.getElementById('cobakuadran2').style="border: 3px solid red; font-size:15px; text-align:center;"
  }

  if (y == "60") {
    document.getElementById('cobakuadran22').style="border: 3px solid green; font-size:15px; text-align:center;"
    
} else {
    document.getElementById('cobakuadran22').style="border: 3px solid red; font-size:15px; text-align:center;"
}
}
function mencobakuadran3() {
    var x = document.getElementById("cobakuadran3").value;
    var y = document.getElementById("cobakuadran33").value;

    
   
    if (x == "40") {
        document.getElementById('cobakuadran3').style="border: 3px solid green; font-size:15px; text-align:center;"
        
    } else {
        document.getElementById('cobakuadran3').style="border: 3px solid red; font-size:15px; text-align:center;"
  }

  if (y == "40") {
    document.getElementById('cobakuadran33').style="border: 3px solid green; font-size:15px; text-align:center;"
    
} else {
    document.getElementById('cobakuadran33').style="border: 3px solid red; font-size:15px; text-align:center;"
}
}
function mencobakuadran4() {
    var x = document.getElementById("cobakuadran4").value;
    var y = document.getElementById("cobakuadran44").value;

    
   
    if (x == "6") {
        document.getElementById('cobakuadran4').style="border: 3px solid green; font-size:15px; text-align:center;"
        
    } else {
        document.getElementById('cobakuadran4').style="border: 3px solid red; font-size:15px; text-align:center;"
  }

  if (y == "6") {
    document.getElementById('cobakuadran44').style="border: 3px solid green; font-size:15px; text-align:center;"
    
} else {
    document.getElementById('cobakuadran44').style="border: 3px solid red; font-size:15px; text-align:center;"
}
}
  ...
  function Functiontwo() {
    ...
    if (x =="1-2 sin x cos x"||x =="1 - 2 sinx cosx"||x =="1-2 sinx cosx"||x =="1-2 sinxcosx"||x =="1-2 sinx cos x"||x =="1 - 2 sinx cos x"||x =="1 - 2 sin x cosx"||x =="1 -2 sin x cos x"||x =="1- 2 sin x cos x") {
        ...
        jawabantwo = `<div class="pembahasan mt-3 mr-3 p-3" style="background-color:red;color:white;">
                        ...
                        <img src="../img/jawaban latihan identitas 2.PNG" alt="">
                        <br>                     
                        </div>`;  
    }
  ...
  function Functionthree() {
    ...
    if (x =="1") {
        ...
        jawabanthree = `<div class="pembahasan mt-3 mr-3 p-3" style="background-color:red;color:white;">
                            Jawaban Anda salah <br> </div>
                            <h5>Perhatikan jawaban berikut ini</h5>
                            <img src="../img/jawaban latihan identitas 3.PNG" alt="">
                            </div>`;  
    }
...
dat.open('GET', '2.kuis2.json', true);
dat.send();
